...
Vendored from the sony-bdp-ip project (../../sony_bdp_ip/client.py) so this
custom_component has no external pip dependency. Keep the two in sync until
sony-bdp-ip is published as an installable package and this can depend on
it via manifest.json's "requirements" instead.
